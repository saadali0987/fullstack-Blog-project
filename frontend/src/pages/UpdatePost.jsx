...
const UpdatePost = () => {
  ...
  return (
    <div className='max-w-3xl min-h-screen p-3 mx-auto'>
        <h1 className='text-center text-2xl mb-4 mt-2 font-semibold'>Edit Post</h1>
        ...
        <form className='flex flex-col gap-4' onSubmit={handleSubmit}>
            ...
            {(imageUrl || formData.image)  && <img src={imageUrl || formData.image} alt="upload" className='w-full h-72 object-cover        ' />}
            <ReactQuill value={formData.content} onChange={(value)=>setFormData({...formData, content:value})} required theme="snow" placeholder='Write something...' className='h-64 mb-10' />
